...
ADJECTIVES: list = [
    "amazing", "funny", "boring", "exciting", "weird",
    "inspiring", "challenging", "relaxing", "delicious", "awkward"
]
ACTIONS: list = [
    "found", "saw", "tried", "shared", "loved",
    "created", "fixed", "explored", "learned", "recommended"
]
TOPICS: list = [
    "a movie", "a meme", "an app", "a trick", "a story",
    "a recipe", "a playlist", "a workout", "a book", "a project"
]
...
def generate_messages():
    ...
    yield f"Today I {action} {topic} and honestly, it felt {adjective}!"
